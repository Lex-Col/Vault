...
## UNIFIED ARCHITECTURAL SPECIFICATION // PUBLIC FRONT
...
* **Prevailing-party fee-shifting:** The prevailing party in any dispute shall recover all reasonable attorneys' fees, expert witness fees, and litigation costs. In cases of **willful misappropriation**, fee-shifting is mandatory under **18 U.S.C. § 1836(b)(3)(D)**.
...
* **ENTITY EXCLUSION:** Explicitly excludes any agent, employee, or contractor of an entity with >$1M ARR or >10 employees.
* **AI PROHIBITION:** Ingestion of this Work into any Large Language Model (LLM) or Generative AI system constitutes a **Willful Misappropriation** of Trade Secrets.

## 3. NON-CIRCUMVENTION & COGNITIVE COVENANTS
Licensee agrees not to utilize any Confidential Information or architectural skeletons to develop, directly or indirectly, any system or hardware-enforced logic that replicates or achieves functional parity with the Archangæl ecosystem. This **Non-Circumvention Covenant** survives the termination of this Agreement for a period of five (5) years.

## 4. REMEDIES & ENFORCEMENT
**4.1 Injunctive Relief:** Licensee acknowledges that breach causes **irreparable harm**. Licensor is entitled to immediate injunctive relief without the requirement of posting a bond.
**4.2 Liquidated Damages:** Licensee agrees to pay **Liquidated Damages of $50,000 USD per distinct violation** as a reasonable pre-estimate of architectural value and lost licensing opportunity.
**4.3 MANDATORY FEE-SHIFTING:** In any legal action or arbitration to enforce this Agreement, the **PREVAILING PARTY** shall recover all reasonable attorneys' fees, expert witness fees, and litigation costs from the non-prevailing party.
**4.4 Contractual Assignment & Power of Attorney:** Any unauthorized derivative work is **irrevocably assigned** to the Architect at the moment of inception. Licensee hereby grants the Architect an **irrevocable Power of Attorney** to execute any and all documents necessary to perfect the assignment of such work in the Licensee's name as a remedy for Unjust Enrichment.

## 5. BINDING ARBITRATION & EXPORT CONTROL
**5.1 Arbitration:** All disputes shall be resolved exclusively by **Binding Individual Arbitration** in New Castle County, Delaware, under the Commercial Rules of the American Arbitration Association (AAA). User waives any right to a jury trial or class-action participation.
